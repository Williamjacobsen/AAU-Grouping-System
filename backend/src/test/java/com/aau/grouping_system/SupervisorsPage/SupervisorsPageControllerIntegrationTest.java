...
class SupervisorsPageControllerIntegrationTest {
    ...
    void testAddSupervisor_ValidRequest_ReturnsCreated() throws Exception {
        ...
        Session session = Mockito.mock(Session.class);
        Coordinator coordinator = Mockito.mock(Coordinator.class);
        SupervisorsPageService.AddSupervisorRequest addRequest = 
            new SupervisorsPageService.AddSupervisorRequest("new@supervisor.com");
    ...
    void testAddSupervisor_InvalidEmail_ReturnsBadRequest() throws Exception {
        // Arrange
        SupervisorsPageService.AddSupervisorRequest invalidRequest = 
            new SupervisorsPageService.AddSupervisorRequest("invalid-email");
    ...
    void testUpdateSupervisorMaxGroups_ValidRequest_ReturnsOk() throws Exception {
        ...
        Coordinator coordinator = Mockito.mock(Coordinator.class);
        Supervisor supervisor = Mockito.mock(Supervisor.class);
        SupervisorsPageController.UpdateMaxGroupsRequest updateRequest = 
            new SupervisorsPageController.UpdateMaxGroupsRequest(5);
    ...
    void testUpdateSupervisorMaxGroups_InvalidMaxGroupsTooLow_ReturnsBadRequest() throws Exception {
        // Arrange
        SupervisorsPageController.UpdateMaxGroupsRequest invalidRequest = 
            new SupervisorsPageController.UpdateMaxGroupsRequest(0); // Below minimum of 1
    ...
    void testUpdateSupervisorMaxGroups_InvalidMaxGroupsTooHigh_ReturnsBadRequest() throws Exception {
        // Arrange  
        SupervisorsPageController.UpdateMaxGroupsRequest invalidRequest = 
            new SupervisorsPageController.UpdateMaxGroupsRequest(101); // Above maximum of 100
